  ...
  return(
    ...
    <div ref={ref}>
      ...
      <header className='flex items-center gap-1 mt-5'>
        ...
        <p className='text-3xl text-myteal text-center font-medium '>Product + UX designer & Web designer from Lagos, Nigeria</p>
      </header>
      <p className='text-mysecondary max-w-2xl text-center mt-4 leading-8 font-light'>
      I use design tools and applications like Figma, Adobe xd, Balsamiq, Illustrator, Photoshop, Indesign and Invision. I've got a passion for beautiful UI/UX</p>
      <div className='Button mt-8'>
      <Button text='Connect with me' type='int' link='/contact'/>
      </div>
      </div>
      <div className='cases'>
        <header className='text-3xl text-mysecondary text-center my-20 font medium'>My projects</header>
      ...
      <div className='TopBar'><TopBar page='work'/></div>
      <Footer/>
      </div>
  )
}
