  ...
  return(
    <div>
      ...
      <header className='flex items-center gap-1 mt-5'>
        <p className='text-3xl text-myblack font-bold text-center'><span className='font-medium text-myblue'>hello,</span> I'm Moyo</p>
        {/* <img className='hidden h-8 smallest:block' src={Emoji} alt='smiling emoji'/> */}
      </header>
      <p className='text-mysecondary max-w-2xl text-left lg:text-center mt-4 leading-8 font-light'>A <span className='font-medium text-black'>Product designer and Front-end developer</span> from Lagos, Nigeria.
      <br/>The ideal platform is one that every user find's easy to use or navigate and also sells the product/service(s) intended at a glance. This is what product design is about.</p>
