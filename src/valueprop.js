                    ...
                    <div className='content flex flex-wrap gap-10'>
                        <div className='Text bg-blue-30 flex-grow my-auto mx-auto px-5 lg:mx-4 py-8 iphone:px-10 xl:flex-grow-0 '>
                            <div className='flex flex-col items-center lg:items-start'>
                                <p className='text-2xl md:text-3xl text-myblack font-large lg:max-w-sm xl:max-w-l leading-10 tracking-tight md:leading-40'>Do you have an idea for a digital product but you don’t know how to go from idea to reality? <span className='whitespace-nowrap'>I can help.</span></p>
                                <div className='button mt-6'>
                                    <Button text='Send me a message' type='ext' link='mailto:martinstm@yahoo.com'/>
                                </div>
                            </div>
                        </div>
